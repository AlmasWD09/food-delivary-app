...
const TopRestaurants = () => {
  ...
  const { data, isLoading } = useQuery({
    ...
    queryFn: async () => {
      const { data } = await axiosPub.get(
        `${process.env.NEXT_PUBLIC_SERVER_URL}/restaurents`
      );
      return data;
    },
  });
  ...
  return (
    <div className="container my-0 mx-auto px-2 space-y-4 ">
      <h3 className="text-4xl font-bold text-center capitalize">
        Top Restaurants
      </h3>
      <div className="flex justify-center">
        <p className="lg:w-2/5 my-3 text-center">
          Discover the best local dining with our curated list of top
          restaurants, offering diverse cuisines and unforgettable experiences.
        </p>
      </div>
      ...
      <div className="flex my-6 justify-center  py-4">
        <Link
          href={"/restaurants"}
