...
const ProfilePage = () => {
  ...
  console.log(session, 'profile page----> 10');
  ...
  const handleUpdateProfile = async (event) => {
    ...
    try{
      const response = await axios.put(`${process.env.NEXT_PUBLIC_SERVER_URL}/update-profile-tab`,userProfileUpdate)
              ...
              <div className=" w-full px-8 pb-8 pt-20  ">
                <div className="space-y-3 border-b-2 pb-4 w-full">
                  ...
                  <div className="flex items-center justify-center gap-4">
                    ...
                    <p>
                      Point <span className="text-red-500 font-bold">4</span>
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-center gap-3  pt-4">
                  ...
                  <div className="flex flex-col items-center">
                    <p className="font-bold text-orange-500">1</p>
                    <p>Delivery</p>
                  </div>
                  <div className="flex flex-col items-center">
