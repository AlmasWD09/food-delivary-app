...
const ProfilePage = () => {
  ...
  const handleProfileUpdate = async (event) => {
    ...
    try {
      const response = await axiosPublic.put(`/user-profile/update-profile/${session?.data?.user?.email}`, updateUserInfo)
  ...
  const handleProfileAddressUpdate = async (event) => {
    ...
    try {
      const response = await axiosPublic.put(`/user-profile/update-address/${session?.data?.user?.email}`, updateUserAddressInfo)
      console.log(response.data);
      if (response.data.modifiedCount > 0) {
        ...
        <div className="h-1/2 flex flex-col lg:flex-row   w-full gap-6 ">
          ...
          <div className="h-fit lg:h-[500px] w-full lg:w-1/3  relative  shadow-lg rounded-t-lg">
            ...
            <div className="flex flex-col items-center justify-center w-full  ">
              {
              session?.data?.user?.image && <div className="w-32 border-4 border-white h-32 rounded-full overflow-hidden absolute top-36">
              <Image
          ...
          <div className="h-fit lg:min-h-[500px] flex-1 w-full shadow-lg p-4">
            <Tabs selectedIndex={tabIndex} onSelect={(index) => setTabIndex(index)}>
                    ...
                    <div className="border p-4">
                      {
                        userAllInfo ? <div>
                          ...
                          <p>House#{house}  Block#{block}  Road#{road}</p>
                  ...
                  <form onSubmit={handleProfileUpdate} className="space-y-6 mt-8">
                    <div className="flex gap-3">
                      <div className="w-full">
                        <label for="firstName" className="block text-sm font-semibold pb-2 text-gray-700">FirstName</label>
                        <input type="text"
                          name="firstName"
                      ...
                      <div className="w-full">
                        <label for="lastName" className="block text-sm font-semibold pb-2 text-gray-700">LastName</label>
                        <input type="text"
                          name="lastName"
                    ...
                    <div className="flex gap-3">
                      <div className="w-full">
                        <label for="phoneNumber" className="block text-sm font-semibold pb-2 text-gray-700">Phone Number</label>
                        <input type="tel"
                          name="phoneNumber"
                      ...
                      <div className="w-full">
                        <label for="email" className="block text-sm font-semibold pb-2 text-gray-700">Email</label>
                        <input type="email"
                          name="email"
                    ...
                    <div className="flex justify-end gap-4">
                      <button className="px-4 py-1 border rounded-md ">Cancel</button>
                      <button type="submit" className="px-4 py-1 bg-primary text-white rounded-md ">Submit</button>
                    </div>
                  </form>
                </div>
              </TabPanel>
              ...
              <TabPanel>
                <div>
                  <form onSubmit={handleProfileAddressUpdate} className="space-y-6 mt-8">
                    <div className="flex gap-3">
                      <div className="w-full">
                        <label for="address" className="block text-sm font-semibold pb-2 text-gray-700">Address Type</label>
                        <input type="text"
                          name="address"
                      ...
                      <div className="w-full">
                        <label for="house" className="block text-sm font-semibold pb-2 text-gray-700">House</label>
                        <input type="tel"
                          name="house"
                    ...
                    <div className="flex gap-3">
                      <div className="w-full">
                        <label for="road" className="block text-sm font-semibold pb-2 text-gray-700">Road</label>
                        <input type="text"
                          name="road"
                      ...
                      <div className="w-full">
                        <label for="block" className="block text-sm font-semibold pb-2 text-gray-700">Block</label>
                        <input type="tel"
                          name="block"
                    ...
                    <div className="w-full">
                      <label for="location" className="block text-sm font-semibold pb-2 text-gray-700">Location</label>
                      <input type="text"
                        name="location"
