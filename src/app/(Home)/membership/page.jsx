...
const page = () => {
  return (
    <div className="bg-black text-white p-10 px-6 lg:px-0">
      ...
      <div className="bg-[#332f2f] border-2 border-[#384457] max-w-[950px] mx-auto p-8 rounded-xl">
        <Image
      ...
      <div className="space-y-4 mt-16">
        ...
        <div className="bg-[#332f2f] border-2 border-[#384457] max-w-[950px] mx-auto rounded-xl">
          <details
            className="max-w-[950px] mx-auto border border-opacity-30 border-[#665857] rounded-lg bg-[#332f2f]"
            open=""
          >
            ...
            <p className="px-4 py-6 pt-0 ml-4 -mt-4 dark:text-gray-600">
              ...
              ordering location, except (for new purchases & renewals starting
              Aug 1st, 2023) and few other restaurants that manage their own
              delivery (for new purchases & renewals starting Oct 26th,2023).
              You can identify these restaurants by the ‘Free Delivery’ label on
