        ...
        <div>
         ...
         className="relative w-full bg-fixed h-[500px] bg-no-repeat bg-center object-cover bg-cover">
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
              <h3 className="lg:text-6xl text-4xl text-white font-bold">Become a Partner</h3>
                <div className="bg-[#FF4D00] mx-auto md:w-2/3 w-[250px] text-center mt-8 p-4">
                    <h3 className="lg:text-xl text-base text-white flex justify-center items-center gap-4">Home <FaArrowRight/> Join as Partner</h3>
                </div>
            </div>
             </div>
             {/*  */}
             <div className="lg:max-w-[1240px] px-3 lg:px-0  mx-auto lg:py-24 py-20">
                <div>
                <h3 className="text-4xl text-center font-bold">Grow Your Business with Us</h3>
                <div className="flex justify-center  text-center">
                <p className="w-2/5  my-3">Expand your restaurant’s business by partnering with us. Join our network and let more people discover and enjoy your delicious food!</p>
                </div>
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 py-8">
                  ...
                  <div className="border rounded-lg p-4">
                   <h3 className="text-2xl mb-3 font-semibold flex items-center gap-3"><FaHeart className="text-primaryLight" /> Customer Loyalty</h3>
            ...
            <div className="md:shadow-xl lg:p-10"> 
                 <form>
                   ...
                   <div className="grid mt-5 lg:grid-cols-2 gap-5">
                     ...
                     <div className="flex col-span-1 flex-col">
                       <label className="block text-sm font-medium text-gray-700">Business Address
                       </label>
                       <input
                         required
                    ...
                    <input type="file" className="border mt-2 w-full rounded-xl p-3" id="fileInput" name="fileInput" accept=".jpg, .jpeg, .png, .pdf"/>
                    </div>
                   <div className="mt-5">
            ...
            <Image className="rounded-lg z-50 object-cover bg-center md:w-[300px] md:h-[200px] w-[250px] lg:h-[400px] h-[200px] lg:w-[600px]" width={600} height={400} src={"https://i.ibb.co.com/hBcc0xq/ex.jpg"} alt="delivery man"/>
             ...
             <div className="py-6">
                <h3 className="text-2xl mt-3 font-semibold">Advantage of Joining Us</h3>
                <p className="text-base my-3">Increase your restaurant’s revenue by joining us. Our platform connects you with food lovers who are constantly searching for exciting and unique dining experiences.</p>
                 <ul>
                    <li className="font-medium flex items-center gap-3"><MdDone className="bg-primaryLight  rounded-full  text-white" /> Boost Your Earnings</li>
                    <li className="font-medium flex items-center gap-3"><MdDone className="bg-primaryLight  rounded-full  text-white" /> Comprehensive Support</li>
                    <li className="font-medium flex items-center gap-3"><MdDone className="bg-primaryLight  rounded-full  text-white" /> Complete Control</li>
