          ...
          <div>
            <div className="flex flex-col justify-center items-center text-center ">
              ...
              <div className="leading-6 mt-[5px]">
                <h3 className="font-normal text-[13px] tracking-[.35rem]">MENU FOR EVERY TASTE</h3>
                <h3 className="font-bold text-3xl text-[#666666] tracking-[.07rem]">Choose your meal plan </h3>
              </div>
            </div>
          </div>
              ...
              >
                ...
                onMouseLeave={() => setHover(0)} className={`flex items-center  ${hover===1 ?'bg-[#68ee5c] -translate-y-4 transition-delay-200' : 'bg-white  transition-transform transform '}`}>
                    ...
                    <div className='ml-[24px]'>
                      ...
                      <div className="text-left ">
                        ...
                        <h3 className={`${hover===1 ?'text-[#ffffff]' : 'text-[#68ee5c]'}`}>$85<span className='text-sm font-light' >only </span> <span className='line-through text-[#a5a5a5] text-sm'>$99</span></h3>
                      </div>
                      ...
                      <div className="mt-[10px] text-left text-[13px] font-light">
                        <div>
                          ...
                          className={`${hover===1 ?'marker:text-white ' : 'marker:text-[#d97706]'}`}>
                      ...
                      <div className="mt-[10px] text-left text-[14px] font-normal ">
                        <button className="flex justify-center items-center space-x-2" ><p className={` ${hover===1 ?'text-white text-[14px] ' : ''}`}>Details</p> <CiLocationArrow1 className={` ${hover===1 ?'text-white text-[14px] rotate-45' : 'text-primary transition-transform duration-300 transform '}`}/></button>
                      </div>
                    </div>
                  </div>
                </SwiperSlide>
                ...
                onMouseLeave={() => setHover(0)} className={`flex items-center  ${hover===2 ?'bg-[#68ee5c] -translate-y-4 transition-delay-200' : 'bg-white transition-transform transform '}`}>
                    ...
                    <div className='ml-[24px]'>
                      ...
                      <div className="text-left ">
                        <h3 className=''>Chickhen Curry</h3>
                        <h3 className={`${hover===2 ?'text-[#ffffff]' : 'text-[#68ee5c]'}`}>$85<span className='text-sm font-light' >only </span> <span className='line-through text-[#a5a5a5] text-sm'>$99</span></h3>
                      </div>
                      ...
                      <div className="mt-[10px] text-left text-[13px] font-light">
                        <div>
                          ...
                          className={`${hover===2 ?'marker:text-white ' : 'marker:text-[#d97706]'}`}>
                            <li>Lorem ipsum dolor sit amet elit.</li>
                            <li>Lorem ipsum dolor elit.</li>
                            <li>Lorem ipsum dolor sit amet elit.</li>
                          </ul>
                      ...
                      {/* button */}
                      <div className="mt-[10px] text-left text-[14px] font-normal ">
                        <button className="flex justify-center items-center space-x-2" ><p className={` ${hover===2 ?'text-white text-[14px] ' : ''}`}>Details</p> <CiLocationArrow1 className={` ${hover===2 ?'text-white text-[14px] rotate-45' : 'text-primary transition-transform duration-300 transform '}`}/></button>
                      </div>
                    </div>
                  </div>
                </SwiperSlide>
                ...
                onMouseLeave={() => setHover(0)} className={`flex items-center  ${hover===3 ?'bg-[#68ee5c] -translate-y-4 transition-delay-200' : 'bg-white  transition-transform transform '}`}>
                    ...
                    <div className='ml-[24px]'>
                      ...
                      <div className="text-left ">
                        <h3 className=''>Chickhen Curry</h3>
                        <h3 className={`${hover===3 ?'text-[#ffffff]' : 'text-[#68ee5c]'}`}>$85<span className='text-sm font-light' >only </span> <span className='line-through text-[#a5a5a5] text-sm'>$99</span></h3>
                      </div>
                      ...
                      <div className="mt-[10px] text-left text-[13px] font-light">
                        <div>
                          ...
                          className={`${hover===3 ?'marker:text-white ' : 'marker:text-[#d97706]'}`}>
                            <li>Lorem ipsum dolor sit amet elit.</li>
                            <li>Lorem ipsum dolor elit.</li>
                            <li>Lorem ipsum dolor sit amet elit.</li>
                          </ul>
